...
This project contains four complete examples for how
[HitchStory](https://hitchdev.com/hitchstory)
can be used as a testing framework that also
autogenerates your documentation.

The following are four versions of the same to do app:
...
All of the above tests run on Github Actions with no tweaking:
