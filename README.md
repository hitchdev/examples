...
*Unlike* with other testing frameworks these stories are type-safe,
...
If you change the REST API response, the command line output, etc.
...
Running this command in any of the above project folders will regenerate all the 
markdown docs for that project from its stories.
